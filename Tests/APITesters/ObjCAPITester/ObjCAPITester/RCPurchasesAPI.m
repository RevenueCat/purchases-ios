...
+ (void)checkAPI {
    ...
    [p.attribution setAttributes: attributes];
    [p.attribution setEmail: nil];
    [p.attribution setEmail: @""];
    [p.attribution setPhoneNumber: nil];
    [p.attribution setPhoneNumber: @""];
    [p.attribution setDisplayName: nil];
    [p.attribution setDisplayName: @""];
    [p.attribution setPushToken: nil];
    [p.attribution setPushToken: [@"" dataUsingEncoding: NSUTF8StringEncoding]];
    [p.attribution setPushTokenString: @""];
    [p.attribution setPushTokenString: nil];
    [p.attribution setAdjustID: nil];
    [p.attribution setAdjustID: @""];
    [p.attribution setAppsflyerID: nil];
    [p.attribution setAppsflyerID: @""];
    [p.attribution setFBAnonymousID: nil];
    [p.attribution setFBAnonymousID: @""];
    [p.attribution setMparticleID: nil];
    [p.attribution setMparticleID: @""];
    [p.attribution setOnesignalID: nil];
    [p.attribution setOnesignalID: @""];
    [p.attribution setCleverTapID: nil];
    [p.attribution setCleverTapID: @""];
    [p.attribution setMixpanelDistinctID: nil];
    [p.attribution setMixpanelDistinctID: @""];
    [p.attribution setFirebaseAppInstanceID: nil];
    [p.attribution setFirebaseAppInstanceID: @""];
    [p.attribution setMediaSource: nil];
    [p.attribution setMediaSource: @""];
    [p.attribution setCampaign: nil];
    [p.attribution setCampaign: @""];
    [p.attribution setAdGroup: nil];
    [p.attribution setAdGroup: @""];
    [p.attribution setAd: nil];
    [p.attribution setAd: @""];
    [p.attribution setKeyword: nil];
    [p.attribution setKeyword: @""];
    [p.attribution setCreative: nil];
    [p.attribution setCreative: @""];
    [p.attribution collectDeviceIdentifiers];
    [RCPurchases.attribution collectDeviceIdentifiers];
