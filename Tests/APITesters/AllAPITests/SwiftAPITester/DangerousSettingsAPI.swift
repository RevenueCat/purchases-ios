...
func checkDangerousSettingsAPI() {
    ...
    let _: DangerousSettings = DangerousSettings(autoSyncPurchases: true, disableRequiredSignatureVerifications: true)
    ...
    let _: Bool = settings.disableRequiredSignatureVerifications
}
