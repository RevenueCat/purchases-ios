...
func paywallViewControllerAPI(_ delegate: Delegate, _ offering: Offering?, _ dismissalDelegate: DismissalDelegate) {
...
@available(iOS 15.0, macOS 12.0, tvOS 15.0, *)
final class DismissalDelegate: PaywallViewControllerDismissalDelegate {
