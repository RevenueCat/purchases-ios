...
/// Identifier that correlates this event with other events for the same ad impression.
@property (nonatomic, readonly, copy) NSString * _Nonnull impressionId;
/// The estimated ad revenue, expressed in micros (millionths) of <code>currency</code>.
@property (nonatomic, readonly) NSInteger revenueMicros;
/// The ISO 4217 currency code for <code>revenueMicros</code>.
@property (nonatomic, readonly, copy) NSString * _Nonnull currency;
/// The accuracy level of the reported <code>revenueMicros</code>.
