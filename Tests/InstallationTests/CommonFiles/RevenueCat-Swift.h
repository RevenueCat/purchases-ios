...
/// Set <code>confirmInWindow</code>.
/// note:
/// This value is only used when StoreKit 2 is in use.
/// Availability: macOS 15.2+
/// \param confirmInWindow The window to show the purchase confirmation UI in proximity to.
///
- (nonnull instancetype)withConfirmInWindow:(NSWindow * _Nonnull)confirmInWindow SWIFT_WARN_UNUSED_RESULT SWIFT_AVAILABILITY(macos,introduced=15.2);
