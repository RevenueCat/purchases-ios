...
///
- (RCConfigurationBuilder * _Nonnull)withObserverMode:(BOOL)observerMode storeKitVersion:(enum RCStoreKitVersion)storeKitVersion SWIFT_WARN_UNUSED_RESULT;
...
- (RCConfigurationBuilder * _Nonnull)withObserverMode:(BOOL)observerMode SWIFT_WARN_UNUSED_RESULT SWIFT_AVAILABILITY(macos,obsoleted=1,message="'with' has been renamed to 'withObserverMode:storeKitVersion:': Explicitly setting the StoreKit version is now required.") SWIFT_AVAILABILITY(watchos,obsoleted=1,message="'with' has been renamed to 'withObserverMode:storeKitVersion:': Explicitly setting the StoreKit version is now required.") SWIFT_AVAILABILITY(tvos,obsoleted=1,message="'with' has been renamed to 'withObserverMode:storeKitVersion:': Explicitly setting the StoreKit version is now required.") SWIFT_AVAILABILITY(ios,obsoleted=1,message="'with' has been renamed to 'withObserverMode:storeKitVersion:': Explicitly setting the StoreKit version is now required.");
@end
...
/// warning:
/// If you are using observer mode with StoreKit 2, ensure that you’re
/// calling <code>Purchases/handleObserverModeTransaction(_:)</code> after making a purchase.
/// \param apiKey The API Key generated for your app from https://app.revenuecat.com/
///
/// \param appUserID The unique app user id for this user. This user id will allow users to share their
/// purchases and subscriptions across devices. Pass <code>nil</code> or an empty string if you want <code>Purchases</code>
...
/// returns:
/// An instantiated <code>Purchases</code> object that has been set as a singleton.
+ (RCPurchases * _Nonnull)configureWithAPIKey:(NSString * _Nonnull)apiKey appUserID:(NSString * _Nullable)appUserID observerMode:(BOOL)observerMode storeKitVersion:(enum RCStoreKitVersion)storeKitVersion;
@end
...
/// warning:
/// If you’re using observer mode with StoreKit 2, configure the SDK with <code>configure(withAPIKey:appUserID:observerMode:storeKitVersion:)</code> passing in <code>.storeKit2</code> as the <code>storeKitVersion</code> and ensure that you call <code>Purchases/handleObserverModeTransaction(_:)</code> after making a purchase.
/// \param apiKey The API Key generated for your app from https://app.revenuecat.com/
///
/// \param appUserID The unique app user id for this user. This user id will allow users to share their
/// purchases and subscriptions across devices. Pass <code>nil</code> or an empty string if you want <code>Purchases</code>
...
/// returns:
/// An instantiated <code>Purchases</code> object that has been set as a singleton.
+ (RCPurchases * _Nonnull)configureWithAPIKey:(NSString * _Nonnull)apiKey appUserID:(NSString * _Nullable)appUserID observerMode:(BOOL)observerMode SWIFT_AVAILABILITY(macos,obsoleted=1,message="'configure' has been renamed to 'configureWithAPIKey:appUserID:observerMode:storeKitVersion:': \n    If you're using observer mode with StoreKit 2, ensure that you call Purchases.handleObserverModeTransaction(result:) after making a purchase.\n    ") SWIFT_AVAILABILITY(watchos,obsoleted=1,message="'configure' has been renamed to 'configureWithAPIKey:appUserID:observerMode:storeKitVersion:': \n    If you're using observer mode with StoreKit 2, ensure that you call Purchases.handleObserverModeTransaction(result:) after making a purchase.\n    ") SWIFT_AVAILABILITY(tvos,obsoleted=1,message="'configure' has been renamed to 'configure(withAPIKey:appUserID:storeKitVersion:)': \n    If you're using observer mode with StoreKit 2, ensure that you call Purchases.handleObserverModeTransaction(result:) after making a purchase.\n    ") SWIFT_AVAILABILITY(ios,obsoleted=1,message="'configure' has been renamed to 'configureWithAPIKey:appUserID:observerMode:storeKitVersion:': \n    If you're using observer mode with StoreKit 2, ensure that you call Purchases.handleObserverModeTransaction(result:) after making a purchase.\n    ");
@end
