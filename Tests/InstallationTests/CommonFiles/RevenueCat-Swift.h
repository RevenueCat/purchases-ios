...
@property (nonatomic, readonly, copy) NSDictionary<NSString *, RCVirtualCurrencyInfo *> * _Nonnull virtualCurrencies;
...
SWIFT_CLASS_NAMED("VirtualCurrencyInfo")
@interface RCVirtualCurrencyInfo : NSObject
