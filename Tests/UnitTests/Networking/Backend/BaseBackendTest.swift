...
class BaseBackendTests: TestCase {
    ...
    final func createDependencies(dangerousSettings: DangerousSettings? = nil,
        ...
        self.identity = IdentityAPI(backendLanes: backendLanes)
        self.token = TokenAPI(backendLanes: backendLanes)
        self.offerings = OfferingsAPI(backendLanes: backendLanes)
        self.webBilling = WebBillingAPI(backendLanes: backendLanes)
        self.offlineEntitlements = OfflineEntitlementsAPI(backendLanes: backendLanes)
        self.internalAPI = InternalAPI(backendLanes: backendLanes)
        self.customerCenterConfig = CustomerCenterConfigAPI(backendLanes: backendLanes)
        self.redeemWebPurchaseAPI = RedeemWebPurchaseAPI(backendLanes: backendLanes)
        self.externalPurchaseTokenAPI = ExternalPurchaseTokenAPI(backendLanes: backendLanes)
        self.virtualCurrenciesAPI = VirtualCurrenciesAPI(backendLanes: backendLanes)
        self.adsAPI = AdsAPI(backendLanes: backendLanes)
        self.remoteConfigAPI = RemoteConfigAPI(backendLanes: backendLanes)
