...
final class DefaultCheckpointWorkflowResolverTests: TestCase {
    ...
    func testTerminalOfferingWorkflowReadsItsOfferingFromTheStep() async throws {
        let secondaryOffering = Self.offering(id: "secondary")
        self.offerings = Self.offerings([self.offering, secondaryOffering])
    ...
    func testAdStepFormatsResolveToCanonicalAdFormats() async throws {
        ...
        for (wire, format) in expectations {
            self.stubAdWorkflow(adUnitId: "ad_unit_1", mediator: "admob", adFormat: wire)
    ...
    func testUnknownAdFormatResolvesAsItsRawValue() async throws {
        self.stubAdWorkflow(adUnitId: "ad_unit_1", mediator: "admob", adFormat: "some_future_format")
    ...
    func testAdStepWithoutAnAdFormatResolvesConfigurationUnavailable() async throws {
        self.stubAdWorkflow(adUnitId: "ad_unit_1", mediator: "admob", adFormat: nil)
    ...
    func testAdStepWithAnEmptyAdFormatResolvesConfigurationUnavailable() async throws {
        self.stubAdWorkflow(adUnitId: "ad_unit_1", mediator: "admob", adFormat: "")
    ...
    func testAdStepPlacementResolves() async throws {
        self.stubAdWorkflow(adUnitId: "ad_unit_1", mediator: "admob", placement: "level_complete")
    ...
    func testAdStepWithoutAPlacementResolvesWithNoPlacement() async throws {
        self.stubAdWorkflow(adUnitId: "ad_unit_1", mediator: "admob", placement: nil)
    ...
    func testAdStepWithAnEmptyPlacementResolvesWithNoPlacement() async throws {
        self.stubAdWorkflow(adUnitId: "ad_unit_1", mediator: "admob", placement: "")
