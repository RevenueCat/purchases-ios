...
// This file is a copy of TestLogHandler.swift in ../../UnitTests/TestHelpers/TestLogHandler.swift
// We tried making this file a symlink but then all tests would fail in CI
