...
class DateFormatterExtensionTests: XCTestCase {
    ...
    func testDateFromBytesReturnsCorrectValueIfPossible() {
        ...
        expect(DateFormatter.iso8601SecondsDateFormatter.iso8601SecondsOrMillisecondsDate(fromBytes: ArraySlice(dateBytes))) == date
    }
    ...
    func testDateWithMillisecondsFromBytesReturnsCorrectValueIfPossible() {
        ...
        let receivedDate = DateFormatter.iso8601SecondsDateFormatter.iso8601SecondsOrMillisecondsDate(fromBytes: ArraySlice(dateBytes))
    ...
    func testDateFromBytesReturnsNilIfItCantBeParsedAsString() {
        expect(DateFormatter.iso8601SecondsDateFormatter.iso8601SecondsOrMillisecondsDate(fromBytes: ArraySlice([0b11]))).to(beNil())
    }
    ...
    func testDateFromBytesReturnsNilIfItCantBeParsedIntoDate() {
        ...
        expect(DateFormatter.iso8601SecondsDateFormatter.iso8601SecondsOrMillisecondsDate(fromBytes: ArraySlice(stringAsBytes))).to(beNil())
    }
    
    func testDateFromBytesReturnsNilIfEmptyData() {
        expect(DateFormatter.iso8601SecondsDateFormatter.iso8601SecondsOrMillisecondsDate(fromBytes: ArraySlice(Data()))).to(beNil())
    }
