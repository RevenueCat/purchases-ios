...
if !git.modified_files.include?("CHANGELOG.latest.md") && !no_changelog
    warn("Please include a [CHANGELOG.latest.md](https://github.com/RevenueCat/purchases-ios/blob/main/CHANGELOG.latest.md) entry. Add [no-changelog] to the PR title to skip this check.")
end
