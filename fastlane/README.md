...
### ios admob_github_release

```sh
[bundle exec] fastlane ios admob_github_release
```

Make github release for purchases-ios-admob
...
```sh
[bundle exec] fastlane ios upload_v1_snapshots_to_emerge
```
...
### ios run_maestro_e2e_tests_ios

```sh
[bundle exec] fastlane ios run_maestro_e2e_tests_ios
```
...
### ios update_swiftinterface_baselines
...
```sh
[bundle exec] fastlane mac test_catalyst
```

Runs tests on Mac Catalyst
