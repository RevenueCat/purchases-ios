...
class ErrorCodeTests: XCTestCase {
    ...
    func testErrorCodeDomainMatchesPurchasesErrorDomain() {
        // Note: `RCPurchasesErrorCodeDomain` is the error domain in Objective-C
        // auto-generated by the compiler from the `ErrorCode` @objc implementation.
        // Its value is still `RevenueCat.ErrorCode` due to https://bugs.swift.org/browse/SR-15841
        let error = ErrorCode.allCases.randomElement()! as NSError
        expect(error.domain) == Purchases.ErrorDomain
    }
