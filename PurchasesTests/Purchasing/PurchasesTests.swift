...
class PurchasesTests: XCTestCase {
    ...
    func testSetAndClearSubscriberAttributesPassesThroughToAttributesManager() {
        setupPurchases()
        ...
        let attribManager = subscriberAttributesManager!

        expect(attribManager.invokedSetEmailParametersList[0]).to(equal(("taquitos@revenuecat.com", appUserID)))
        expect(attribManager.invokedSetEmailParametersList[1]).to(equal((nil, appUserID)))

        expect(attribManager.invokedSetPhoneNumberParametersList[0]).to(equal(("8000000000", appUserID)))
        expect(attribManager.invokedSetPhoneNumberParametersList[1]).to(equal((nil, appUserID)))

        expect(attribManager.invokedSetDisplayNameParametersList[0]).to(equal(("taquitos", appUserID)))
        expect(attribManager.invokedSetDisplayNameParametersList[1]).to(equal((nil, appUserID)))

        expect(attribManager.invokedSetPushTokenParametersList[0]).to(equal(("atoken".data(using: .utf8), appUserID)))
        expect(attribManager.invokedSetPushTokenParametersList[1]).to(equal((nil, appUserID)))

        expect(attribManager.invokedSetAdjustIDParametersList[0]).to(equal(("adjustIt", appUserID)))
        expect(attribManager.invokedSetAdjustIDParametersList[1]).to(equal((nil, appUserID)))

        expect(attribManager.invokedSetAppsflyerIDParametersList[0]).to(equal(("appsFly", appUserID)))
        expect(attribManager.invokedSetAppsflyerIDParametersList[1]).to(equal((nil, appUserID)))

        expect(attribManager.invokedSetFBAnonymousIDParametersList[0]).to(equal(("fb", appUserID)))
        expect(attribManager.invokedSetFBAnonymousIDParametersList[1]).to(equal((nil, appUserID)))

        expect(attribManager.invokedSetMparticleIDParametersList[0]).to(equal(("Mpart", appUserID)))
        expect(attribManager.invokedSetMparticleIDParametersList[1]).to(equal((nil, appUserID)))

        expect(attribManager.invokedSetOnesignalIDParametersList[0]).to(equal(("oneSig", appUserID)))
        expect(attribManager.invokedSetOnesignalIDParametersList[1]).to(equal((nil, appUserID)))

        expect(attribManager.invokedSetMediaSourceParametersList[0]).to(equal(("media", appUserID)))
        expect(attribManager.invokedSetMediaSourceParametersList[1]).to(equal((nil, appUserID)))

        expect(attribManager.invokedSetCampaignParametersList[0]).to(equal(("testCampaign", appUserID)))
        expect(attribManager.invokedSetCampaignParametersList[1]).to(equal((nil, appUserID)))

        expect(attribManager.invokedSetAdGroupParametersList[0]).to(equal(("anAdGroup", appUserID)))
        expect(attribManager.invokedSetAdGroupParametersList[1]).to(equal((nil, appUserID)))

        expect(attribManager.invokedSetAdParametersList[0]).to(equal(("anAd", appUserID)))
        expect(attribManager.invokedSetAdParametersList[1]).to(equal((nil, appUserID)))

        expect(attribManager.invokedSetKeywordParametersList[0]).to(equal(("Akeyword", appUserID)))
        expect(attribManager.invokedSetKeywordParametersList[1]).to(equal((nil, appUserID)))

        expect(attribManager.invokedSetCreativeParametersList[0]).to(equal(("ImAnArtist", appUserID)))
        expect(attribManager.invokedSetCreativeParametersList[1]).to(equal((nil, appUserID)))
    }
