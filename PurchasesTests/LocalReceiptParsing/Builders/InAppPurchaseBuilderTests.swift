...
class InAppPurchaseBuilderTests: XCTestCase {
    ...
    let purchaseDate = try! Date.rc_from(year: 2019, month: 5, day: 3, hour: 1, minute: 55, second: 1)
    let originalPurchaseDate = try! Date.rc_from(year: 2018, month: 6, day: 22, hour: 1, minute: 55, second: 1)
    let expiresDate = try! Date.rc_from(year: 2018, month: 6, day: 22, hour: 1, minute: 55, second: 1)
    let cancellationDate = try! Date.rc_from(year: 2019, month: 7, day: 4, hour: 7, minute: 1, second: 45)
