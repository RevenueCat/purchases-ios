...
private extension HTTPClient {
    ...
    func parse(urlResponse: URLResponse?,
        ...
        func parse(_ response: HTTPURLResponse, _ statusCode: HTTPStatusCode) throws -> [String: Any] {
        ...
        let result: Result<HTTPResponse?, Error> = Result { try parse(httpURLResponse, statusCode) }
    ...
    func handle(urlResponse: URLResponse?,
        ...
        // TODO: is this called if not should retry?
