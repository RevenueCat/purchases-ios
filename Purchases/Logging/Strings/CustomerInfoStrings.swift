...
enum CustomerInfoStrings {
    ...
    case invalidating_consumerinfo_cache
    case no_cached_consumerinfo
    case consumerinfo_stale_updating_in_background
    case consumerinfo_stale_updating_in_foreground
    case consumerinfo_updated_from_network
    case consumerinfo_updated_from_network_error(error: Error)
    case sending_latest_consumerinfo_to_delegate
    case sending_updated_consumerinfo_to_delegate
    case vending_cache
    case error_getting_data_from_consumerinfo_json(error: Error)
    case invalid_json
...
extension CustomerInfoStrings: CustomStringConvertible {
    ...
    var description: String {
        ...
        case .consumerinfo_updated_from_network_error(let error):
        ...
        case .error_getting_data_from_consumerinfo_json(let error):
