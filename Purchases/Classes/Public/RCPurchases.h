...
/**
 @typedef RCAttributionSource
 @brief Enum of supported attribution networks
 @constant RCAttributionSourceAppleSearchAds Apple's search ads
 @constant RCAttributionSourceAppsFlyer AppsFlyer https://www.appsflyer.com/
 @constant RCAttributionSourceAdjust Adjust https://www.adjust.com/
 */
...
/**
 ...
 @param network Enum for the network the data is coming from, see `RCAttributionSource` for supported networks
 */
