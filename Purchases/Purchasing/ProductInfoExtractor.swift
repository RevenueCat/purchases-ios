...
class ProductInfoExtractor {
    ...
    func extractInfo(from product: LegacySKProduct) -> ProductInfo {
...
private extension ProductInfoExtractor {
    ...
    func extractIntroDurationType(for product: LegacySKProduct) -> IntroDurationType {
    ...
    func extractSubscriptionGroup(for product: LegacySKProduct) -> String? {
    ...
    func extractDiscounts(for product: LegacySKProduct) -> [PromotionalOffer]? {
    ...
    func extractPaymentMode(for product: LegacySKProduct) -> ProductInfo.PaymentMode {
        if #available(iOS 11.2, macOS 10.13.2, tvOS 11.2, *),
           let paymentMode = product.introductoryPrice?.paymentMode {
    ...
    func extractIntroPrice(for product: LegacySKProduct) -> NSDecimalNumber? {
        if #available(iOS 11.2, macOS 10.13.2, tvOS 11.2, *),
    ...
    func extractNormalDuration(for product: LegacySKProduct) -> String? {
        if #available(iOS 11.2, macOS 10.13.2, tvOS 11.2, *),
    ...
    func extractIntroDuration(for product: LegacySKProduct) -> String? {
        if #available(iOS 11.2, macOS 10.13.2, tvOS 11.2, *),
