...
#warning(
    """
    You're using a beta release (4.0.0-beta.10). If that's not intentional, you'll want to point to one of the \
...
public extension Purchases {
     ...
     * See [Attribution](https://docs.revenuecat.com/docs/attribution)
