...
concatenate_circleci_configs() {
  ...
  if ! git diff --cached --quiet HEAD -- "$config_folder"; then
    ...
    echo "# DO NOT EDIT this file directly. Instead, edit the files in the .circleci/configuration/ directory and rely on the pre-commit hook to update this file.\n\n" >> "$output_file"
