...
enum ColorComputationHelpers {
    ...
    static func selectColorWithBestContrast(from colors: [Color], againstColor: Color) -> Color {
    ...
    private static func contrastRatio(luminance1: Double, luminance2: Double) -> Double {
    ...
    static func extractRGBComponents(from color: Color) -> (Double, Double, Double) {
