...
public enum TestData {
    ...
    public static let customerInfo: CustomerInfo = {
        return .decode(
        """
        {
            "schema_version": "4",
