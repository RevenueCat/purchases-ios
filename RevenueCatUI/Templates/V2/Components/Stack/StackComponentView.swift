...
/// then clamps the *wrapped* height. Before iOS 16 the fallback is a plain `frame(maxHeight:)`, which inflates
/// the box to the maximum whenever the parent offers it, so these previews only exist on iOS 16 and later.
