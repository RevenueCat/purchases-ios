...
public struct PaywallWebViewController {
    ...
    ///     are replying to.
    ///   - variables: The variables to deliver. Place app-defined values under a `"custom"` object;
    ///     the SDK-managed top-level keys (`"locale"`, `"color_scheme"`) are reserved.
    ...
    private func evaluate(script: String) {
        ...
        guard let webView = self.webView,
            ...
            // The web view was returned to the pool / navigated elsewhere — don't post into
            // unrelated content.
