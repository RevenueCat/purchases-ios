...
//
//  PaywallCondensedFooterViewController.swift
//
...
/// A view controller for displaying `PaywallData` for an `Offering` in a condensed footer format.
///
/// Consumers should normally use ``PaywallViewController`` instead.
///
/// - Seealso: ``PaywallView`` for `SwiftUI`.
@available(iOS 15.0, macOS 12.0, tvOS 15.0, *)
@objc(RCPaywallCondensedFooterViewController)
public final class PaywallCondensedFooterViewController: PaywallViewController {

    /// Initialize a `PaywallCondensedFooterViewController` with an optional `Offering`
    ...
    /// Initialize a `PaywallCondensedFooterViewController` with an `Offering` identifier.
    ...
    /// Initialize a `PaywallCondensedFooterViewController` with an `offeringIdentifier` and `presentedOfferingContext`.
    ...
    /// Initialize a `PaywallCondensedFooterViewController` with an `offeringIdentifier` and custom `fontName`.
    ...
    /// Initialize a `PaywallCondensedFooterViewController` with an `offeringIdentifier`,
