...
extension RulesEngine.Value {
    ...
    var asNumber: Double? {
        ...
        case .array, .object:
            let stringified = RulesEngine.jsString(self)
...
extension RulesEngine {
    ...
    static func looseEq(_ lhs: Value, _ rhs: Value) -> Bool {
        switch (lhs, rhs) {
    ...
    /// `"[object Object]"`.
    static func jsString(_ value: Value) -> String {
        switch value {
        case .null:
            return "null"
        case .undefined:
    ...
    static func jsArrayJoin(_ items: [Value]) -> String {
    ...
    /// `jsString`.
    static func jsArrayElementString(_ value: Value) -> String {
    ...
    static let jsObjectString = "[object Object]"
    ...
    static func jsParseFloat(_ value: Value) -> Double {
    ...
    private static let numericPrefixPattern = #"^[+-]?(\d+\.?\d*|\.\d+)([eE][+-]?\d+)?"#

    private static func parseFloatPrefix(_ string: String) -> Double {
    ...
    static func strictEq(_ lhs: Value, _ rhs: Value) -> Bool {
        switch (lhs, rhs) {
        case (.null, .null):
            return true
