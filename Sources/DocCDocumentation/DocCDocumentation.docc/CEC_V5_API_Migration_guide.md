...
> Note: This migration guide is only applicable if you're using RevenueCat in Custom Entitlements Computation mode. If that's not the case, or you don't know what that is, please use the regular [4.x to 5.x Migration guide](Sources/DocCDocumentation/DocCDocumentation.docc/V5_API_Migration_guide.md).
