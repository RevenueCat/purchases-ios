...
class SystemInfo {
    ...
    var appTransactionJWT: String? {
        get { self._appTrasansactionJWT.value }
        set { self._appTrasansactionJWT.value = newValue }
    }
    ...
    private let _appTrasansactionJWT: Atomic<String?> = nil
