...
enum StoreKitStrings {
    ...
    case sk2_could_not_build_installments_info(compoundProductIdentifier: CompoundProductIdentifier)
...
extension StoreKitStrings: LogMessage {
    ...
    var description: String {
        ...
        case .sk2_could_not_build_installments_info(let compoundProductIdentifier):
            return "Could not build installments info for the requested billing plan. Will not return " +
            "a product for \(compoundProductIdentifier.compoundProductIdentifier)"
