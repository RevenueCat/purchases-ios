        ...
        do {
            if #available(iOS 15.0, tvOS 15.0, macOS 12.0, watchOS 8.0, *) {
                eventsManager = EventsManager(
                    ...
                    store: try EventStore.createDefault(applicationSupportDirectory: applicationSupportDirectory)
                )
...
internal extension Purchases {
    ...
    func flushPaywallEvents(count: Int) async throws -> Int {
        return try await self.eventsManager?.flushEvents(count: count) ?? 0
    }
