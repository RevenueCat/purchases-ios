...
class InternalAPI {
    ...
    func postPaywallEvents(events: [AnyStoredFeatureEventType], completion: @escaping ResponseHandler) {
...
extension InternalAPI {
    ...
    /// - Throws: `BackendError`
    @available(iOS 15.0, macOS 12.0, tvOS 15.0, watchOS 8.0, *)
    func postPaywallEvents<EventType>(events: [StoredFeatureEvent<EventType>]) async throws {
