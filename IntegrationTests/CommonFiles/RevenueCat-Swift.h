...
///
- (void)customerInfoWithCompletion:(void (^ _Nonnull)(RCCustomerInfo * _Nullable, NSError * _Nullable))completion;
...
///
- (void)purchases:(RCPurchases * _Nonnull)purchases didReceiveUpdatedCustomerInfo:(RCCustomerInfo * _Nonnull)customerInfo;
/// Called when a user initiates a promotional in-app purchase from the App Store.
/// If your app is able to handle a purchase at the current time, run the deferment block in this method.
