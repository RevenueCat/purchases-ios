...
typedef SWIFT_ENUM_NAMED(NSInteger, RCBackendErrorCode, "BackendErrorCode", closed) {
...
/// Note: This can be <code>nil</code>, see <code>Purchases/restoreTransactions(completionBlock:)</code>
@property (nonatomic, readonly, copy) NSDate * _Nullable originalPurchaseDate;
...
/// note:
/// This can be nil, see -<code>Purchases.restoreTransactions(completionBlock:)</code>
...
/// networks.
///
+ (void)addAttributionData:(NSDictionary<NSString *, id> * _Nonnull)data fromNetwork:(enum RCAttributionNetwork)network;
/// Send your attribution data to RevenueCat so you can track the revenue generated by your different campaigns.
/// \param data Dictionary provided by the network. See https://docs.revenuecat.com/docs/attribution
///
/// \param network Enum for the network the data is coming from, see <code>AttributionNetwork</code> for supported
/// networks.
///
/// \param maybeNetworkUserId User Id that should be sent to the network. Default is the current App User Id.
///
+ (void)addAttributionData:(NSDictionary<NSString *, id> * _Nonnull)data fromNetwork:(enum RCAttributionNetwork)network forNetworkUserId:(NSString * _Nullable)maybeNetworkUserId;
@end
...
/// This also affects the behavior of <code>Purchases/restoreTransactions(completionBlock:)</code>.
...
///
- (void)createAlias:(NSString * _Nonnull)alias completionBlock:(void (^ _Nullable)(RCPurchaserInfo * _Nullable, NSError * _Nullable))maybeCompletionBlock;
...
///
- (void)identify:(NSString * _Nonnull)appUserID completionBlock:(void (^ _Nullable)(RCPurchaserInfo * _Nullable, NSError * _Nullable))maybeCompletion;
...
/// \param appUserID The appUserID that should be linked to the current user.
///
- (void)logIn:(NSString * _Nonnull)appUserID completionBlock:(void (^ _Nonnull)(RCPurchaserInfo * _Nullable, BOOL, NSError * _Nullable))completion;
...
/// See https://docs.revenuecat.com/docs/user-ids
- (void)logOutWithCompletionBlock:(void (^ _Nullable)(RCPurchaserInfo * _Nullable, NSError * _Nullable))maybeCompletion;
/// Resets the Purchases client clearing the saved appUserID.
/// This will generate a random user id and save it in the cache.
- (void)resetWithCompletionBlock:(void (^ _Nullable)(RCPurchaserInfo * _Nullable, NSError * _Nullable))maybeCompletion;
...
///
- (void)offeringsWithCompletionBlock:(void (^ _Nonnull)(RCOfferings * _Nullable, NSError * _Nullable))completion;
@end
...
///
- (void)purchaserInfoWithCompletionBlock:(void (^ _Nonnull)(RCPurchaserInfo * _Nullable, NSError * _Nullable))completion;
...
/// \param identifiers A set of product identifiers for in app purchases setup via AppStoreConnect:
...
///
- (void)productsWithIdentifiers:(NSArray<NSString *> * _Nonnull)identifiers completionBlock:(void (^ _Nonnull)(NSArray<SKProduct *> * _Nonnull))completion;
...
///
- (void)purchaseProduct:(SKProduct * _Nonnull)product withCompletionBlock:(void (^ _Nonnull)(SKPaymentTransaction * _Nullable, RCPurchaserInfo * _Nullable, NSError * _Nullable, BOOL))completion;
...
/// \param completion A completion block that is called when the purchase completes.
///
- (void)purchasePackage:(RCPackage * _Nonnull)package withCompletionBlock:(void (^ _Nonnull)(SKPaymentTransaction * _Nullable, RCPurchaserInfo * _Nullable, NSError * _Nullable, BOOL))completion;
...
/// \param completion A completion block that is called when the purchase completes.
///
- (void)purchasePackage:(RCPackage * _Nonnull)package withDiscount:(SKPaymentDiscount * _Nonnull)discount completionBlock:(void (^ _Nonnull)(SKPaymentTransaction * _Nullable, RCPurchaserInfo * _Nullable, NSError * _Nullable, BOOL))completion SWIFT_AVAILABILITY(tvos,introduced=12.2) SWIFT_AVAILABILITY(maccatalyst,introduced=13.0) SWIFT_AVAILABILITY(watchos,introduced=6.2) SWIFT_AVAILABILITY(macos,introduced=10.14.4) SWIFT_AVAILABILITY(ios,introduced=12.2);
...
- (void)syncPurchasesWithCompletionBlock:(void (^ _Nullable)(RCPurchaserInfo * _Nullable, NSError * _Nullable))completion;
...
/// <code>Purchases/syncPurchases(completionBlock:)</code> if you need to restore transactions programmatically.
- (void)restoreTransactionsWithCompletionBlock:(void (^ _Nullable)(RCPurchaserInfo * _Nullable, NSError * _Nullable))completion;
...
///
/// \param receiveEligibility A block that receives a dictionary of product_id -> <code>IntroEligibility</code>.
///
- (void)checkTrialOrIntroductoryPriceEligibility:(NSArray<NSString *> * _Nonnull)productIdentifiers completionBlock:(void (^ _Nonnull)(NSDictionary<NSString *, RCIntroEligibility *> * _Nonnull))receiveEligibility;
...
///
- (void)setAdjustID:(NSString * _Nonnull)adjustID;
...
///
- (void)setFBAnonymousID:(NSString * _Nonnull)fbAnonymousID;
