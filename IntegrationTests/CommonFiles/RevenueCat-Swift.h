...
/// Constructs an Error with the <code>ErrorCode/configurationError</code> code.
/// note:
/// This error is used when the configuration in App Store Connect doesn’t match the configuration
/// in the RevenueCat dashboard.
+ (NSError * _Nonnull)configurationErrorWithMessage:(NSString * _Nullable)message SWIFT_WARN_UNUSED_RESULT;
...
/// Deprecated
- (void)customerInfoWithCompletion:(void (^ _Nonnull)(RCCustomerInfo * _Nullable, NSError * _Nullable))completion SWIFT_DEPRECATED_MSG("use getCustomerInfoWithCompletion:", "getOfferingsWithCompletion");
/// Deprecated
- (void)productsWithIdentifiers:(NSArray<NSString *> * _Nonnull)productIdentifiers completion:(void (^ _Nonnull)(NSArray<SKProduct *> * _Nonnull))completion SWIFT_DEPRECATED_MSG("use getProductsWithIdentifiers:completion:", "getProductsWithIdentifiers");
/// Deprecated
- (void)offeringsWithCompletion:(void (^ _Nonnull)(RCOfferings * _Nullable, NSError * _Nullable))completion SWIFT_DEPRECATED_MSG("use getOfferingsWithCompletion:", "getOfferingsWithCompletion");
...
///
- (void)createAlias:(NSString * _Nonnull)alias completion:(void (^ _Nullable)(RCCustomerInfo * _Nullable, NSError * _Nullable))completion SWIFT_DEPRECATED_MSG("use logIn instead", "logIn:completion:");
...
/// This completion block will receive an error if there’s been one.
///
- (void)identify:(NSString * _Nonnull)appUserID completion:(void (^ _Nullable)(RCCustomerInfo * _Nullable, NSError * _Nullable))completion SWIFT_DEPRECATED_MSG("use logIn instead");
/// Resets the Purchases client clearing the saved appUserID.
/// This will generate a random user id and save it in the cache.
- (void)resetWithCompletion:(void (^ _Nullable)(RCCustomerInfo * _Nullable, NSError * _Nullable))completion SWIFT_DEPRECATED_MSG("use logOut instead", "logOutWithCompletion:");
@end
