//
//  FullScreenContentDelegate.swift
//
...
internal extension Tracking {
    ...
    /// `GoogleMobileAds.FullScreenContentDelegate` wrapper that forwards events to the user's delegate
    /// while reporting display, click, and revenue events for full-screen ads to the adapter.
    @MainActor
    final class FullScreenContentDelegate: NSObject, GoogleMobileAds.FullScreenContentDelegate {
