...
public final class AdMobRewardedInterstitialPresenter: AdPresenter {
    ...
    /// Loads and presents the rewarded interstitial ad for `params.adIdentifier`, completing once it is dismissed
    ...
    public func present(
        ...
        let presentation = RewardedPresentation(format: .rewardedInterstitial)
