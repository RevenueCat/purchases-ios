...
/// Since RevenueCat_CustomEntitlementComputation is a static framework, the bundle containing the resources is copied into the final product.
    static let module: Bundle = {
        let bundleName = "RevenueCat_RevenueCat_CustomEntitlementComputation"
        ...
        fatalError("unable to find bundle named RevenueCat_RevenueCat_CustomEntitlementComputation")
    }()
}
