...
enum ConfigureStrings {
    ...
    static let configuring_purchases_proxy_url_set = "Purchases is being configured using a proxy for RevenueCat " +
        " with URL: %@"
    static let debug_enabled = "Debug logging enabled"
    static let delegate_set = "Delegate set"
    static let purchase_instance_already_set = "Purchases instance already set. Did you mean to configure " +
        "two Purchases objects?"
    static let initial_app_user_id = "Initial App User ID - %@"
    static let no_singleton_instance = "There is no singleton instance. Make sure you configure Purchases before " +
