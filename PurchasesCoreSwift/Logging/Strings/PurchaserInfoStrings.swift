...
@objc(RCPurchaserInfoStrings) public class PurchaserInfoStrings: NSObject {
    @objc public var checking_intro_eligibility_locally_error: String { "Couldn't check intro eligibility locally, error: %@" }
    @objc public var checking_intro_eligibility_locally_result: String { "Local intro eligibility computed locally. Result: %@" }
    ...
    @objc public var purchaserinfo_stale_updating_in_background: String { "PurchaserInfo cache is stale, updating from network in background." }
    @objc public var purchaserinfo_stale_updating_in_foreground: String { "PurchaserInfo cache is stale, updating from network in foreground." }
