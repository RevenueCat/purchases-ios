...
@objc(RCPurchaserInfoStrings) public class PurchaserInfoStrings: NSObject {
    @objc public var checking_intro_eligibility_error: String { "couldn't check intro eligibility locally, error: %@" } //error
    @objc public var checking_intro_eligibility_result: String { "Local intro eligibility computed locally. Result: %@" } //debug
    @objc public var checking_intro_eligibility: String { "Attempting to check intro eligibility locally" } //debug
