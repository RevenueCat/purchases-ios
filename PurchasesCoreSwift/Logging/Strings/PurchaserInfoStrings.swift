...
@objc(RCPurchaserInfoStrings) public class PurchaserInfoStrings: NSObject {
    ...
    @objc public var purchaserinfo_stale_updating_in_background: String { "PurchaserInfo cache is stale, updating from network in background." } //debug -
    @objc public var purchaserinfo_stale_updating_in_foreground: String { "PurchaserInfo cache is stale, updating from network in foreground." } //debug - 
