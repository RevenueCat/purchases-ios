...
@objc(RCPurchaseStrings) public class PurchaseStrings: NSObject {
    @objc public var cannot_purchase_product_appstore_configuration_error: String { "Could not purchase SKProduct. There is a problem with your configuration in App Store Connect. More info here: https://errors.rev.cat/configuring-products" }
    @objc public var entitlements_revoked_syncing_purchases: String { "Entitlements revoked for product identifiers: %@. \nsyncing purchases" }
    ...
    @objc public var skpayment_missing_from_skpaymenttransaction: String { "There is a problem with the SKPaymentTransaction missing an SKPayment - this is an issue with the App Store." }
    @objc public var skpayment_missing_product_identifier: String { "There is a problem with the SKPayment missing a product identifier - this is an issue with the App Store." }
}
